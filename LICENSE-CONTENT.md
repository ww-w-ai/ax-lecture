...
The **documentation and lecture content** in this repository — prose, slides, and
handouts (the `.md` files, excluding code blocks / Mermaid / scripts, which are
licensed under MIT; see `LICENSE`) — is licensed under
